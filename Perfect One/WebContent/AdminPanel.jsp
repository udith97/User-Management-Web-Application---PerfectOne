...
<title>Perfect One || Admin Panel</title>
<%
...
<!--::header part start::-->
	...
	<!-- Header part end-->
                ...
                <div class="note">
                    <p style="color:white;font-size:25pt;">Admin Panel</p>
                </div>
				...
				<div class="row">					
					<div class="col-md-6">			
						<div class="form-group">	
							<a href="ListUsers.jsp">User Management</a>
						</div>
					</div>
				</div>
			</div>				
		...
		<div class="container register-form">
			<div class="form-content">						
				<div class="row">					
					<div class="col-md-6">			
						<div class="form-group">	
							<a href="url">Package Management</a>
						</div>
					</div>
				</div>
			</div>				
		...
		<div class="container register-form">
			<div class="form-content">						
				<div class="row">					
					<div class="col-md-6">			
						<div class="form-group">	
							<a href="url">Supplier Management</a>
						</div>
					</div>
				</div>
			</div>				
